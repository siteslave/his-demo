<div class="panel-group" id="accordionProcedure">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordionProcedure" href="#collapseMain">
                    <i class="fa fa-ambulance"></i> การให้หัตถการทั่วไป
                    <i class="fa fa-chevron-circle-up pull-right" id="spnDownMain"></i>
                </a>
            </h4>
        </div>
        <div class="panel-body panel-collapse collapse in" id="collapseMain">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordionProcedure" href="#collapseDental">
                    <i class="fa fa-ambulance"></i> การให้หัตถการทันตกรรม
                    <i class="fa fa-chevron-circle-up pull-right" id="spnDownDental"></i>
                </a>
            </h4>
        </div>
        <div class="panel-body panel-collapse collapse" id="collapseDental">
